...
All seed data is for a fictional TKOS patient (Lily Chen, DOB 2007-04-22). The `report/sample_data.py` has older hardcoded sample data (wrong age/HR) — prefer `get_report_data()` for accurate values.
